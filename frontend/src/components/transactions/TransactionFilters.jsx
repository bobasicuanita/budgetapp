...
const TransactionFilters = memo(({ 
  ...
  // Optional: hide wallet and currency filters (for wallet details view)
  hideWalletFilter = false
}) => {
  ...
  const activeFilterCount = useMemo(() => {
    ...
    if (!hideWalletFilter && filterWallets.length > 0) count += filterWallets.length;
    ...
    if (!hideWalletFilter && filterCurrencyType !== 'all') count += 1;
    return count;
  }, [
    filterTransactionTypes,
    filterWallets,
...
TransactionFilters.propTypes = {
  ...
  hideWalletFilter: PropTypes.bool,
};
