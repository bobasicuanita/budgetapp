        ...
        {loadingArchived ? (
          ...
          <Stack gap="md">
            <Text size="xs" c="gray.9" ta="center">
              Wallets that are no longer active. They don't affect balances or
              net worth.
            </Text>
            <Text size="sm" c="gray.11" ta="center">
              Archiving keeps your history but removes the wallet from balances
              and reports.
            </Text>
            ...
            <Group justify="center" mt="lg">
              <Button color="blue.9" onClick={handleCloseArchivedModal}>
                Close
              </Button>
            </Group>
          </Stack>
